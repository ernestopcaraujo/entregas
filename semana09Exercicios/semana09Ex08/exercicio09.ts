...
nela terá os atributos nome:string, valor:number, codigo: number, quantidade: 
number, emEstoque: boolean e apenas declare um método chamado comprar(), 
esse método é opcional e recebe como parâmetro produto do tipo Produto e quantidade do tipo number. 
Em um projeto angular, na pasta assets adicione o arquivo exercicio09.ts e siga as instruções abaixo:
